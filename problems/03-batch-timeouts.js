...
/*function batchTimeouts(callbacks, delays) {
  // Your code here
   //Woah, I didn't really use my sense for this ooo!!!
...
function batchTimeouts(callbacks, delays) {
  // Your code here
  const timeouts = callbacks.map((cb, i) => {
    const timeout = setTimeout(cb, delays[i]);
    return timeout;
  })

  return timeouts;
}
//This gave me the answer and a colourful series of errors as a souvenir.
